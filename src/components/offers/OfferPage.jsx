      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex items-center justify-between gap-4 p-4 bg-gray-50 dark:bg-slate-800 rounded-2xl flex-wrap">
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="flex items-center gap-4 bg-transparent border-0 p-0 cursor-pointer text-left focus:outline-none"
                >
                  <img
                    src={
                  ...
                  />
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white hover:text-[var(--primary-light)] transition-colors">
                      {offer.user?.name}
                    </p>
              ...
              {owner && (
                <div className="flex gap-2 shrink-0">
                  <button
                    ...
                    className="px-4 py-2 rounded-xl text-sm font-bold border border-gray-200 dark:border-slate-700 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800 cursor-pointer"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => setConfirmDeleteOpen(true)}
                    className="px-4 py-2 rounded-xl text-sm font-bold text-red-600 border border-red-200 hover:bg-red-50 dark:hover:bg-red-900/20 cursor-pointer"
                  >
                    Delete
                  </button>
                </div>
        ...
        <div className="lg:col-span-1">
          <OfferReviews
            ...
            listingOwnerId={offer.user?._id || offer.user?.id}
          />
        </div>
      </div>
