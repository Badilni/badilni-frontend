    ...
    <div className="flex justify-center items-center gap-1.5 pt-6" dir="ltr">
      ...
      {[...Array(totalPages)].map((_, i) => {
        ...
        return (
          <button
            ...
            style={{
              backgroundColor: isActive ? 'var(--primary-light)' : 'var(--whiteBackground)',
              borderColor: isActive ? 'var(--primary-light)' : 'var(--border-color)',
      ...
      <button
        ...
        style={{
          backgroundColor: 'var(--whiteBackground)',
          borderColor: 'var(--border-color)',
          color: currentPage === totalPages ? 'var(--Disabled)' : 'var(--black-text)',
          border: '1px solid var(--border-color)',
