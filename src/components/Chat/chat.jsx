...
const initialChatsData = [
  {
    ...
    fileBreakdown: [
      { name: "Documents", count: "10 files", size: "15MB", color: "text-blue-500", icon: () => <span className="font-bold text-xs">DOC</span> },
      { name: "Photos", count: "2 files", size: "4MB", color: "text-green-500", icon: () => <span className="font-bold text-xs">IMG</span> }
    ]
  },
  {
    id: "chat_2",
    ...
    fileBreakdown: [
      { name: "Photos", count: "5 files", size: "12MB", color: "text-green-500", icon: () => <span className="font-bold text-xs">IMG</span> }
    ]
  }
];
