    ...
    <section className="bg-[var(--whiteBackground)] border-y border-[var(--gray-text)]/10 rounded-[2rem] py-20 px-6 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-4 mb-16">
        ...
        <p className="text-[var(--gray-text)] text-sm max-w-xl mx-auto leading-relaxed">
          One skill shared, a thousand paths enlightened. Explore how our
          ecosystem fosters exponential growth.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 relative">
        ...
        <div className="flex flex-col items-center text-center space-y-4 relative z-10 group cursor-pointer">
          ...
          <span className="text-xs font-semibold text-[var(--gray-text)] transition-colors duration-300 group-hover:text-[var(--black-text)]">
            01. Spark
          </span>
          <p className="text-xs text-[var(--gray-text)] max-w-[240px] leading-relaxed">
            An expert decides to share a single insight, transforming years of
            experience into a concise lesson.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center space-y-4 relative z-10 group cursor-pointer">
          ...
          <span className="text-xs font-semibold text-[var(--gray-text)] transition-colors duration-300 group-hover:text-[var(--primary-light)]">
            02. Velocity
          </span>
          <p className="text-xs text-[var(--gray-text)] max-w-[240px] leading-relaxed">
            That lesson reaches a seeker, who applies it instantly to a
            real-world project, creating immediate value.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center space-y-4 relative z-10 group cursor-pointer">
          ...
          <p className="text-xs text-[var(--gray-text)] max-w-[240px] leading-relaxed">
            The seeker becomes a mentor, passing the torch to numbers. The
            ripple becomes a wave of change.
          </p>
        </div>
      </div>
    </section>
