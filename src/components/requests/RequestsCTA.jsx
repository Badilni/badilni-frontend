export default function RequestsCTA({ totalShowing = 0, totalCount = 0, isLoadingMore = false, onLoadMore, onPostRequest }) {
  return (
    <>
      {totalShowing < totalCount && (
        <div className="mt-14 flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500">
            Showing {totalShowing} of {totalCount} requests
          </p>
        </div>
      )}
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 to-blue-700 dark:from-indigo-800 dark:to-blue-900 p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <p className="text-white/70 text-sm md:text-base max-w-md">
              Post your request, set the credits you are offering, and connect with experts who can help.
            </p>
          </div>
