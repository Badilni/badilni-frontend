...
// Re-exported for backward compatibility with anything still importing
// getAccentColor from here directly — the real implementation now lives in
// utils/getAccentColor.js (also used by OfferCard) so it isn't duplicated.
