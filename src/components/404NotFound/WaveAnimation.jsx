const WaveBackground = ({
  opacityTop = 'opacity-15',
  opacityBottom = 'opacity-25',
}) => {
  return (
    <>
      <style>{`
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-0 h-[160px] md:h-[220px] pointer-events-none">
        <div className={`w-[200%] h-full flex animate-wave-top ${opacityTop}`}>
          <svg
            ...
            className="w-1/2 h-full fill-blue-600"
          >
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-0 h-[140px] md:h-[180px] pointer-events-none">
        <div
          className={`w-[200%] h-full flex animate-wave-bottom-fast absolute bottom-0 left-0 ${opacityBottom}`}
        >
          <svg
            viewBox="0 0 1200 120"
            preserveAspectRatio="none"
            className="w-1/2 h-full fill-blue-500"
          >
