...
// Helper function to calculate the percentage distribution of ratings per star (1 to 5)
...
// Presentational component that displays the summary stats, average rating, and visual progress bars
...
// Container component responsible for fetching review data specifically for the rating breakdown
const ProfileRatingUser = ({ userId, averageRating, reviewsCount }) => {
  const { data: ratingsStatsData } = useUserReviews({
    userId: userId,
    type: 'received',
    limit: 100,
    fields: 'rating',
  })
  const statsReviews = ratingsStatsData?.data?.reviews || []
...
export default ProfileRatingUser
