      ...
      <div className="space-y-4 text-slate-200">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            <span className="text-[10px] px-3 py-1 rounded-lg bg-blue-950/40 text-blue-300 font-bold border border-blue-900/40">
              React JS
            </span>
            <span className="text-[10px] px-3 py-1 rounded-lg bg-blue-950/40 text-blue-300 font-bold border border-blue-900/40">
              Node.js
        ...
        <div className="space-y-2">
          <p className="text-[10px] font-extrabold text-purple-400 uppercase tracking-wider">
            Skills I Want to Learn
          </p>
          <div className="flex flex-wrap gap-1.5">
            <span className="text-[10px] px-3 py-1 rounded-lg bg-purple-950/40 text-purple-300 font-bold border border-purple-900/40">
              UI/UX Design
            </span>
            <span className="text-[10px] px-3 py-1 rounded-lg bg-purple-950/40 text-purple-300 font-bold border border-purple-900/40">
              Figma
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center pb-2 border-b border-slate-800/60">
          <p className="text-xs font-bold text-slate-200">
            Matching Swap Partners
          </p>
          <span className="text-[9px] bg-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-md font-bold">
            2 Found
          </span>
        </div>
      ...
      <div className="space-y-3 h-[130px] overflow-y-auto scrollbar-hide pr-1">
        <div className="flex gap-2">
          <div className="max-w-[85%] rounded-2xl p-3 bg-slate-800/70 border border-slate-750 text-[11px] text-slate-200 leading-relaxed shadow-sm">
            Hi! I saw your React profile. Would you be interested in swapping
            for UI/UX training?
          </div>
        </div>
        <div className="flex gap-2 justify-end">
          <div className="max-w-[85%] rounded-2xl p-3 bg-gradient-to-r from-blue-600 to-indigo-650 text-white text-[11px] font-semibold leading-relaxed shadow-sm">
            Sure! That sounds like a perfect swap. Let's schedule a Zoom call
            this evening!
          </div>
        </div>
      </div>
...
export default function HomeFeatures() {
  ...
  const features = [
    {
      ...
      largeIcon: (
        <svg
          className="w-36 h-36 text-blue-500/10 dark:text-blue-450/15"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1}
    ...
    },
    {
      ...
      largeIcon: (
        <svg
          className="w-36 h-36 text-emerald-500/10 dark:text-emerald-450/15"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1}
    ...
    },
    {
      ...
      largeIcon: (
        <svg
          className="w-36 h-36 text-purple-500/10 dark:text-purple-450/15"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1}
  ...
  return (
    <div
      id="why-badilni-section"
      className="w-full bg-slate-50/50 dark:bg-slate-950/20 py-16 md:py-24 transition-colors duration-200"
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm md:text-base text-gray-500 dark:text-slate-400 mt-4 font-semibold max-w-xl mx-auto leading-relaxed">
            Badilni is built around community trust, collaboration, and
            barrier-free skill sharing. Here is how we redefine online learning.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {features.map((feat, index) => (
            ...
            >
              ...
              <div
                className={`absolute -inset-[1px] bg-gradient-to-r ${feat.color} rounded-[2rem] opacity-0 group-hover:opacity-100 blur-[2px] transition-all duration-500 z-0`}
              />
              <div
                className={`absolute -inset-[8px] bg-gradient-to-r ${feat.color} rounded-[2.5rem] opacity-0 group-hover:opacity-15 blur-xl transition-all duration-500 z-0 pointer-events-none`}
              />
              ...
              <div className="relative z-10 bg-gradient-to-br from-white to-slate-50/70 dark:from-slate-900 dark:to-slate-950/60 border border-gray-150/80 dark:border-slate-800/85 p-8 rounded-[2rem] h-full flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div className="relative z-10">
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 shrink-0 ${feat.bg} transition-transform duration-300 group-hover:scale-110 shadow-md`}
                  >
                    {feat.icon}
                  </div>
            ...
            <div className="lg:w-5/12 space-y-6 w-full">
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-500 dark:text-slate-400 leading-relaxed font-semibold">
                  Get started today in three simple steps. Click on any step
                  indicator on the right to see how easy it is to exchange
                  expertise.
                </p>
              </div>
              ...
              {steps.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute left-0 top-0 bottom-0 w-1.5 bg-gradient-to-b ${step.color} transition-all duration-300 transform origin-top ${isSelected ? 'scale-y-100' : 'scale-y-0'}`}
                    />

                    <div className="flex items-start gap-4">
                      {/* Step Badge */}
                      <span
                        className={`text-[10px] font-extrabold uppercase px-2.5 py-1 rounded-lg bg-gradient-to-r ${step.color} text-white tracking-widest shrink-0 mt-1.5 shadow-sm`}
                      >
                        {step.badge}
                      </span>
                      ...
                      <div className="flex-1 min-w-0">
                        <h4
                          className={`text-lg font-black text-slate-800 dark:text-slate-100 ${isSelected ? 'text-blue-600 dark:text-blue-400' : ''}`}
                        >
                          {step.title}
                        </h4>
